...
public class GraphShowAlarm extends Activity {
    ImageView graph ;
    Button btn_bck ;
    Bitmap gsource;
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                ...
                case 350:
                    ...
                    Toast.makeText(GraphShowAlarm.this, tip, Toast.LENGTH_LONG).show();
                    finish();
                default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_show_alarm);
        graph = (ImageView)findViewById(R.id.graph_data_alarm);
        btn_bck = (Button) findViewById(R.id.graph_back_alarm);

        final Intent intent = getIntent();
        GraphAlarm alarm = (GraphAlarm)intent.getSerializableExtra("alarm");
        try {
            ...
            j.put("time",alarm.time);
            String path = Constant.rootDir+"/"+alarm.time;
            //把空格换成_
            //path = path.replace(" ","_");
